...
import { Achievements, BestTeammate, CompletedProject, StudentInfo } from "@/app/profile/interface";
import { getBestTeammate, getStudentInfo, getStudentMonthlyLogtime } from "@/app/profile/studentInfo";
import StudentOverview from "@/app/profile/studentOverview";

export default async function studentSearch({ params }: { params: { login: string } })
{
	let	login = (await params).login;
